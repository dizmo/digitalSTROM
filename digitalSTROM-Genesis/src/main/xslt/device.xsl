...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:variable name="pagename">digitalSTROM - Raum</xsl:variable>
  <xsl:template name="scripts">
    ...
    <xsl:template name="body">
        <div class="front">
			<div id="frontcontent">Device Front</div>
        </div>
        <div class="back device_back" style="display:none;">
        	<div class="backside_container" style="width:216px;height:216px;">
				...
				<div id="backcontent">Device Back</div>
			</div>
        </div>
