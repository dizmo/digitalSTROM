...
flab.controller.genesis = flab.Class.extend(flab.controller.genesisBase, /** @lends flab.controller.genesis.prototype */{
	...
	get_button_widget_for_zone : function(zoneid , displayname) {
		var me = this;
		me.install_and_start_dizmo("bundle://dizmos/button.dizmo.zip" , "ch.futurelab.dizmo.digitalstrom.button" , zoneid , displayname);
	},
	/**
	 * Will be called from the frontside view instance, if the user clicks a button and wants to
	...
	get_usage_widget_for_zone : function(zoneid , displayname) {
		var me = this;
		me.install_and_start_dizmo("bundle://dizmos/usage.dizmo.zip" , "ch.futurelab.dizmo.digitalstrom.usage" , zoneid , displayname);
	},
	/**
	 * Will be called from the frontside view instance, if the user clicks a button and wants to
	...
	get_activities_widget_for_zone : function(zoneid , displayname) {
		var me = this;
		me.install_and_start_dizmo("bundle://dizmos/activities.dizmo.zip" , "ch.futurelab.dizmo.digitalstrom.activities" , zoneid , displayname);
	},
	/**
	 * Will be called from the frontside view instance, if the user clicks a button and wants to
	...
	get_zone_widget_for_zone : function(zoneid , displayname) {
		var me = this;
		me.install_and_start_dizmo("bundle://dizmos/zone.dizmo.zip" , "ch.futurelab.dizmo.digitalstrom.zone" , zoneid , displayname);
	},
	...
	coundConnect : function() {
		...
		dizmo.setAttribute('settings/iconimage' , 'IconActive.png');
	},

	lostConnection : function() {
		var me = this;
		console.log('could not connect to dss!');
		dizmo.setAttribute('settings/iconimage' , 'IconInActive.png');
	},
	/**
