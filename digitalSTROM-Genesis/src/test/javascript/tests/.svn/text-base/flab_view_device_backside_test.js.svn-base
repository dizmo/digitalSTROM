...
flab.Test.run(function(T, A) {
    T.Runner.add(new T.Case({
        name:  'flab.view.device.backside',
        ...
        test: function() {
			...
			var flab_view_device_backside_delegate = flab.Class.extend(Object,{
				constructor : function() {
					var self = this;
				}
			});
			var flab_view_device_backside_delegate_instance = new flab_view_device_backside_delegate();
			A.nothingRaised(function() {
				self.backside_view = new flab.view.device.backside(flab_view_device_backside_delegate_instance,connector_stub_instance);
			},'constructor');
			A.nothingRaised(function() {
